...
" <leader><leader>s 双向搜索
" <leader><leader>j 向下搜索行
" <leader><leader>k 向上搜索行
...
if index(g:bundle_group, 'enhanced') >= 0
    ...
    let g:vim_dict_dict = [
                ...
                \ '~/.config/nvim/dict',
                \ ]
    let g:vim_dict_config = {'html':'html,javascript,css', 'markdown':'text', 'text': ''}
...
if index(g:bundle_group, 'YCM') >= 0
    ...
    " 两个字符自动触发语义补全
    " TODO 和ycm_min_num_identifier_candidate_chars 是否需要对齐
